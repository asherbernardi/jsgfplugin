...
public class JsgfGrammarDeclarationImpl extends GrammarDeclarationMixin implements JsgfGrammarDeclaration {

  public JsgfGrammarDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JsgfGrammarName getGrammarName() {
    return PsiTreeUtil.getChildOfType(this, JsgfGrammarName.class);
  }
