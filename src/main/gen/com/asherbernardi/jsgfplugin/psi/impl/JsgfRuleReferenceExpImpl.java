...
public class JsgfRuleReferenceExpImpl extends RuleReferenceMixin implements JsgfRuleReferenceExp {

  public JsgfRuleReferenceExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JsgfVisitor visitor) {
    visitor.visitRuleReferenceExp(this);
  }
