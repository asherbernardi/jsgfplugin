...
public class JsgfExpansionWithTagExpImpl extends ExpansionWithTagMixin implements JsgfExpansionWithTagExp {

  public JsgfExpansionWithTagExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JsgfVisitor visitor) {
    visitor.visitExpansionWithTagExp(this);
  }
  ...
  public JsgfTag getTag() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, JsgfTag.class));
  }
