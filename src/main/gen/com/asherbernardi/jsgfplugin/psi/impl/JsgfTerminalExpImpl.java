...
public class JsgfTerminalExpImpl extends TerminalMixin implements JsgfTerminalExp {

  public JsgfTerminalExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JsgfVisitor visitor) {
    visitor.visitTerminalExp(this);
  }
